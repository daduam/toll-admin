...
CREATE TABLE `booths` (
  ...
  `type` enum('manual','electronic') NOT NULL,
  `station_id` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `station_id_idx` (`station_id`),
  CONSTRAINT `station_id` FOREIGN KEY (`station_id`) REFERENCES `stations` (`id`) ON DELETE CASCADE
...
-- Dump completed on 2022-08-11 21:00:07
